...
export default function West({ position }) {
  return (
    <group position={position}>
      <GreenLand position={[0, 0, 0]} />
      <GreenLand position={[0, 0, -8]} />
      <GreenLand position={[0, 0, -16]} />
      <Sea position={[0, 0, 8]} />
      ...
      <Sea position={[-24, 0, 8]} />
      <Sea position={[-24, 0, -16]} />
      <GreenLand position={[-32, 0, -0]} />
      <Sea position={[-32, 0, 8]} />
      <Sea position={[-32, 0, -8]} />
      <Sea position={[-32, 0, -16]} />
      ...
      <GreenLand position={[0, 0, -24]} />
      <GreenLand position={[-8, 0, -24]} />
      <Sea position={[-48, 0, 8]} />
      <Sea position={[-48, 0, 0]} />
      <Sea position={[-48, 0, -8]} />
      <Sea position={[-32, 0, -24]} />
      <Sea position={[-24, 0, -24]} />
      <Sea position={[-16, 0, -24]} />
    </group>
  );
}
